<script lang="ts">
  ...
  let columnMappings = new ColumnMappings({
    timestamp: "date",
    caption: "text",
    url: "url",
    type: "category",
    ...
    first_4_tagged: "list[category]",
    taggedUsers: "list[category]",
    id: "category",
    coauthorProducers_username: "category",
    coauthorProducers: "list[category]",
        ...
        <Tooltip.Root openDelay={0}>
          ...
          >
            <ul class="list-disc list-inside flex flex-col gap-2">
              <li>
                Use <span class="text-primary font-bold">@</span><span
                  class="opacity-70">username</span
                > to search posts from a profile
              </li>

              <li>
                You can include a link to a profile: <span class="font-bold"
              ...
              <li>
                You can also include a link to a specific post: <span
                  class="font-bold">https://instagram.com</span
                ><span class="opacity-70">/p/postID</span>, to search for
      ...
      <div class="flex flex-col gap-1">
        <Tooltip.Root openDelay={0}>
          ...
          <TooltipContent transitionConfig={{ duration: 100, y: -5 }}>
            This will return {maxItems} results for every user you include. If you
            were to include 3 users, you will get approximately
            {maxItems * 3} results.
          </TooltipContent>
        </Tooltip.Root>
        <input
