<script lang="ts">
  ...
  const columnMappings = new ColumnMappings({
    ...
    url: "url",
    description: "text",
    emphasizedKeywords: "list[category]",
    "searchQuery.term": "category",
    "searchQuery.page": "number",
    "searchQuery.domain": "url",
    resultsTotal: "number",
    "aiOverview.type": "category",
    "aiOverview.content": "text",
    "aiOverview.sources": "list[category]",
  });
        ...
        <div class="flex flex-col gap-2 justify-between w-full">
          <div class="flex gap-1">
            ...
            <Tooltip.Root openDelay={0}>
              ...
              >
                <div>
                  <p>Recommended number sits around 2 to 10 pages.</p>
                  <p>
                    Each one of those pages will return around 100 results,
                    which adds up to somewhere in between 200 to 1000 results.
                  </p>
                </div>
              </TooltipContent>
            </Tooltip.Root>
